...
type
  ...
  {$ifdef HASCODEPAGE}
  RawUnicode = type AnsiString(1200); //CP_UTF16 Codepage for an UnicodeString
  {$else}
...
type
  ...
  public
    ...
    // the current value
    procedure UseExternalCount(var aCountPointer: Integer);   {$ifdef HASINLINE}inline;{$endif}
