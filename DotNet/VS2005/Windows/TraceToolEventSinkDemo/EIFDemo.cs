...
The event sink pont to the TraceTool.EIFEventSink class (assembly is TraceToolEventSink.dll)

<eventSink name="TraceToolSink" description="Outputs events to the tracetool API." 
type="TraceTool.EIFEventSink, TraceToolEventSink, Version=1.0.1833.44444, Culture=neutral, PublicKeyToken=35bb89f90be2164b">
