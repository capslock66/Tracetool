...
namespace TraceTool 
{
	...
	///    type="TraceTool.EIFEventSink, TraceToolEventSink, Version=9, Culture=neutral, PublicKeyToken=35bb89f90be2164b">
	...
	public class TraceToolEventSink : EventSink, IEventContainerSink 
	{
		...
		/// <summary>
		/// Initialize the tracetoo EventSink using suplied parameters.
		/// </summary>
