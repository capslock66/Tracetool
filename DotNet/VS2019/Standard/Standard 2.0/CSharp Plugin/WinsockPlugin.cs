...
namespace CSharpPlugin
{
    ...
    // a demo plugin
    public class WinsockPlugin : ITracePLugin
    {
        WinTrace PlugTraces;
        TraceNode ActionNodes, BeforeDeleteNodes, Timer;
        const string PlugName = "CSharpPlugin";
        ...
        public void Start()
        {
            ...
            PlugTraces = new WinTrace("CSHARP", "CSharp Plugin");
            ...
            PlugTraces.Debug.Send("Sample CSharp Plugin started");
            ...
            server.Start(socket =>
            {
                socket.OnOpen = () =>
                {
                    PlugTraces.Debug.Send("Open!");
                    allSockets.Add(socket);
                };
                socket.OnClose = () =>
                {
                    PlugTraces.Debug.Send("Close!");
