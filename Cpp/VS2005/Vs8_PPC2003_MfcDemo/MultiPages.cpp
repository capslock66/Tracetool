...
BEGIN_MESSAGE_MAP(MultiPages, CPropertyPage)
    ON_BN_CLICKED(IDC_NEWWIN, &MultiPages::OnBnClickedNewwin)
    ON_BN_CLICKED(IDC_DISPLAYWIN, &MultiPages::OnBnClickedDisplaywin)
    ON_BN_CLICKED(IDC_SAYHELLO, &MultiPages::OnBnClickedSayhello)
    ON_BN_CLICKED(IDC_SAVETEXT, &MultiPages::OnBnClickedSavetext)
    ON_BN_CLICKED(IDC_SAVETOXML, &MultiPages::OnBnClickedSavetoxml)
    ON_BN_CLICKED(IDC_LOADXML, &MultiPages::OnBnClickedLoadxml)
    ON_BN_CLICKED(IDC_MULTICOL, &MultiPages::OnBnClickedMulticol)
END_MESSAGE_MAP()
