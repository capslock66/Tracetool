                       ...
                       UINT uBalloonTimeout /*=10*/)
{
    ...
    strncpy_s(m_tnd.szTip, 128, szToolTip, m_nMaxTooltipLength);
...
BOOL CSystemTray::StepAnimation()
{
    ...
    m_nCurrentIcon++;
    if ((SIZE_T)m_nCurrentIcon >= m_IconList.size())
        m_nCurrentIcon = 0;
...
#else
    strncpy_s(strBuffer, 1024,m_tnd.szTip, m_nMaxTooltipLength-1);
#endif
