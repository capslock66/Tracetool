...
{var ttrace=null;var ttraceScript=null;var headId=null;var request;var stackTrace;var uuid;var requestId=0;var toSend=[];var nbDone=0;var winTraceSingeton=null;var watchesSingeton=null;var clientId="";var host="127.0.0.1:81";var traceClasses={};var isChromeExtension;var isBrowser;var isNodeJs;var isRequireJs;detectEnvironment();if(isNodeJs)
...
{isChromeExtension=false;isBrowser=false;isNodeJs=false;isRequireJs=false;try{if((typeof require==="function")&&(typeof define==="function"))
isRequireJs=true;if((typeof chrome==="object")&&(typeof chrome.extension==="object"))
...
{if(!this.enabled)
return;var stack;var stackList;var stackLength;var callObj;var callName;level=level||0;var group=new traceClasses.MemberNode("Call stack").setFontDetail(0,true);group.viewerKind=4;this.members.add(group);if(isNodeJs)
...
module.exports=ttrace;if(isRequireJs)
define({ttrace:ttrace});if(isBrowser)
