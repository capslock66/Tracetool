...
- Download the [Viewer 64 bits Zip file](https://github.com/capslock66/Tracetool/releases/download/VIEWER_15_0/Viewer64.zip "Viewer64.zip") and unpack the file into a folder of your chose .

- Download the [Viewer 32 bits Zip file](https://github.com/capslock66/Tracetool/releases/download/VIEWER_15_0/Viewer32.zip "Viewer32.zip") and unpack the file into a folder of your chose .
