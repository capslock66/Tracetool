...
- Winget: comming soon...
- Download and install the [Viewer Setup](/GithubFiles/Setup.exe "Setup.exe") that unpack files on Program files (x86)\Tracetool.\
- Download the [Viewer Zip file](/GithubFiles/Viewer32.zip "Viewer32.zip") and unpack the file into a folder of your chose (windows only).\
